...
import { Camera, Circle, RefreshCw, Settings2 } from 'lucide-react';
...
export const ControlsOverlay: React.FC<ControlsOverlayProps> = ({ onSnapshot, onCapture, onSwitch, onSettings }) => {
  return (
